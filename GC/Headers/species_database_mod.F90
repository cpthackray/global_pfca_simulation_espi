...
!
    ...
    SELECT CASE( TRIM ( Name ) )
          ...
          CASE( 'PFTA', 'PFDOA', 'PFUNA', 'PFDA', &
               'PFNA', 'PFOA', 'PFHPA', 'PFHXA', 'PFPA', &
               'PFBUA', 'PFPRA', 'SCPFCA'   )
             ...
             SELECT CASE( TRIM( Name ) )
                 ...
                 CASE( 'PFHXA'     )
                    ...
                    MW_g = 314.0_fp
                 CASE( 'PFPA'     )
                    Henry_K0 = 170000.0_fp
                    MW_g = 264.0_fp
                 CASE( 'PFBUA'     )
                    Henry_K0 = 910000.0_fp
                    MW_g = 214.0_fp
                 CASE( 'PFPRA'     )
                    Henry_K0 = 4900000.0_fp
                    MW_g = 164.0_fp
                 CASE( 'SCPFCA'     )
                    Henry_K0 = 26000000.0_fp
                    MW_g = 114.0_fp
             END SELECT

             FullName      = 'PFC soluble tracer'
             Formula       = 'PFC'
             MW_g          = MW_g
             Is_Gas        = T
             Is_Drydep     = T
          ...
          CASE( 'FTAL122', 'FTAL121','FTAL102', 'FTAL101', &
               'FTAL82', 'FTAL81', &
               'FTAL62', 'FTAL61','FTAL42', 'FTAL41', &
               'FTAL22', 'FTAL21', 'FPAN82', 'FPAN81', &
               'FPAN122', 'FPAN121','FPAN102', 'FPAN101', &
               'FPAN62', 'FPAN61','FPAN42', 'FPAN41', &
               'FTCA12', 'FTCA10', &
               'FPAN22', 'FPAN21', 'FTCA8', 'FTCA6', &
               'FTCA4', 'FTCA2', 'FT1OOH8', 'FTOOH8', &
               'FT1OOH12', 'FTOOH12', &
               'FT1OOH10', 'FTOOH10', &
               'FT1OOH6', 'FTOOH6', 'FT1OOH4', 'FTOOH4', &
               'FT1OOH2', 'FTOOH2',&
               'FT1OH12', 'FTOH12', &
               'FT1OH10', 'FTOH10', &
               'FT1OH8', 'FTOH8', &
               'FT1OH6', 'FTOH6', 'FT1OH4', 'FTOH4', &
               'FT1OH2', 'FTOH2',&
               'PFAL12', 'PFAL10', &
               'PFAL8', 'PFAL6', 'PFAL4', 'PFAL2', &
               'PFALHY12', 'PFALHY10', &
               'PFALHY8', 'PFALHY6', 'PFALHY4', 'PFALHY2' )

             FullName      = 'PFC insoluble tracer'
             Formula       = 'PFC'
             MW_g          = 500.0_fp
             Is_Gas        = T
             Is_Drydep     = T
          ...
          CASE('FTI82','FTI62','FTI42', &
               'FTOH82','FTOH62','FTOH42', &
               'FTOLE82', 'FTOLE62', 'FTOLE42', &
               'FTI122','FTI102',&
               'FTOH122','FTOH102', &
               'FTOLE122', 'FTOLE102')
             SELECT CASE( TRIM( Name ) )
          ...
          CASE( 'FPER122','FPER121','FPER102','FPER101', &
               'FPER82','FPER81','FPER62','FPER61', &
               'FPER42','FPER41','FPER22','FPER21', &
               'PFOO12','PFOO11','PFOO10','PFOO9', &
               'PFOO8','PFOO7','PFOO6','PFOO5', &
               'PFOO4','PFOO3','PFOO2', 'PFOO1', &
               'FTOO12','FTOO10', &
               'FTOO8','FTOO6','FTOO4','FTOO2' )


             FullName      = 'PFC intermediate'
             Formula       = 'PFC'
             MW_g          = 500.0_fp
             Is_Gas        = T
             Is_Drydep     = F
